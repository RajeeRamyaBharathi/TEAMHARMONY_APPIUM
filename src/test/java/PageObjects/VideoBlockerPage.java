...
public class VideoBlockerPage {
    ...
    public WebElement videoBlockerButton;

    @AndroidFindBy(uiAutomator = "new UiSelector().text(\"Channel Filters\")")
    public WebElement channelFiltersOption;

    @AndroidFindBy(uiAutomator = "new UiSelector().text(\"Language and Region Filters\")")
    public WebElement languageRegionFiltersOption;
    
    @AndroidFindBy(uiAutomator = "new UiSelector().text(\"Other Filters\")")
    public WebElement otherFiltersOption;
    
    @AndroidFindBy(uiAutomator = "new UiSelector().resourceId(\"android:id/checkbox\").instance(0)")
    public WebElement videoBlockerCheckbox;
